...
public class Address {
    ...
    public Address withEntityReference(String entityReference) {
        this.entityReference = entityReference;
        return this;
    }
    ...
    public Address withEntityType(String entityType) {
        this.entityType = entityType;
        return this;
    }
    ...
    public Address withInsuredAddress(String insuredAddress) {
        this.insuredAddress = insuredAddress;
        return this;
    }
    ...
    public Address withIsAuditExpoProrated(String isAuditExpoProrated) {
        this.isAuditExpoProrated = isAuditExpoProrated;
        return this;
    }
    ...
    public Address withMasterRecordGid(String masterRecordGid) {
        this.masterRecordGid = masterRecordGid;
        return this;
    }
    ...
    public Address withStateDesc(String stateDesc) {
        this.stateDesc = stateDesc;
        return this;
    }
    ...
    public Address withSysExposureIsUnits(String sysExposureIsUnits) {
        this.sysExposureIsUnits = sysExposureIsUnits;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(',');
        sb.append("insuredAddress");
        sb.append('=');
        sb.append(((this.insuredAddress == null)?"<null>":this.insuredAddress));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.insuredAddress == null)? 0 :this.insuredAddress.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((this.country == rhs.country)||((this.country!= null)&&this.country.equals(rhs.country)))&&((this.zipCode == rhs.zipCode)||((this.zipCode!= null)&&this.zipCode.equals(rhs.zipCode))))&&((this.city == rhs.city)||((this.city!= null)&&this.city.equals(rhs.city))))&&((this.addressType == rhs.addressType)||((this.addressType!= null)&&this.addressType.equals(rhs.addressType))))&&((this.entityType == rhs.entityType)||((this.entityType!= null)&&this.entityType.equals(rhs.entityType))))&&((this.masterRecordGid == rhs.masterRecordGid)||((this.masterRecordGid!= null)&&this.masterRecordGid.equals(rhs.masterRecordGid))))&&((this.stateDesc == rhs.stateDesc)||((this.stateDesc!= null)&&this.stateDesc.equals(rhs.stateDesc))))&&((this.county == rhs.county)||((this.county!= null)&&this.county.equals(rhs.county))))&&((this.isAuditExpoProrated == rhs.isAuditExpoProrated)||((this.isAuditExpoProrated!= null)&&this.isAuditExpoProrated.equals(rhs.isAuditExpoProrated))))&&((this.countryCode == rhs.countryCode)||((this.countryCode!= null)&&this.countryCode.equals(rhs.countryCode))))&&((this.entityReference == rhs.entityReference)||((this.entityReference!= null)&&this.entityReference.equals(rhs.entityReference))))&&((this.stateCode == rhs.stateCode)||((this.stateCode!= null)&&this.stateCode.equals(rhs.stateCode))))&&((this.insuredAddress == rhs.insuredAddress)||((this.insuredAddress!= null)&&this.insuredAddress.equals(rhs.insuredAddress))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.line1 == rhs.line1)||((this.line1 != null)&&this.line1 .equals(rhs.line1))))&&((this.sysExposureIsUnits == rhs.sysExposureIsUnits)||((this.sysExposureIsUnits!= null)&&this.sysExposureIsUnits.equals(rhs.sysExposureIsUnits))));
    }
