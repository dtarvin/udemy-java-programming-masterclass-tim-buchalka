...
public class DiscountCoverageRating {
    ...
    private PremiumAttributes__12 premiumAttributes;
    @JsonIgnore
    ...
    public DiscountCoverageRating withCCoverage(String cCoverage) {
        this.cCoverage = cCoverage;
        return this;
    }
    ...
    public DiscountCoverageRating withCCoverageCode(String cCoverageCode) {
        this.cCoverageCode = cCoverageCode;
        return this;
    }
    ...
    @JsonProperty("CDiscountCovRating")
    public void setCDiscountCovRating(String cDiscountCovRating) {
        this.cDiscountCovRating = cDiscountCovRating;
    }

    public DiscountCoverageRating withCDiscountCovRating(String cDiscountCovRating) {
        this.cDiscountCovRating = cDiscountCovRating;
        return this;
    }
    ...
    public DiscountCoverageRating withCFinalAnnDisPremium(String cFinalAnnDisPremium) {
        this.cFinalAnnDisPremium = cFinalAnnDisPremium;
        return this;
    }
    ...
    public DiscountCoverageRating withCRatingFormula(String cRatingFormula) {
        this.cRatingFormula = cRatingFormula;
        return this;
    }
    ...
    public DiscountCoverageRating withCRatingFunction(String cRatingFunction) {
        this.cRatingFunction = cRatingFunction;
        return this;
    }
    ...
    public DiscountCoverageRating withCSeq(String cSeq) {
        this.cSeq = cSeq;
        return this;
    }
    ...
    public DiscountCoverageRating withEntityReference(String entityReference) {
        this.entityReference = entityReference;
        return this;
    }
    ...
    public DiscountCoverageRating withEntityStatus(String entityStatus) {
        this.entityStatus = entityStatus;
        return this;
    }
    ...
    public DiscountCoverageRating withEntityType(String entityType) {
        this.entityType = entityType;
        return this;
    }
    ...
    public DiscountCoverageRating withIsCovManuallyRated(String isCovManuallyRated) {
        this.isCovManuallyRated = isCovManuallyRated;
        return this;
    }
    ...
    public DiscountCoverageRating withLobCode(String lobCode) {
        this.lobCode = lobCode;
        return this;
    }
    ...
    public DiscountCoverageRating withProductCode(String productCode) {
        this.productCode = productCode;
        return this;
    }
    ...
    public DiscountCoverageRating withRiskState(String riskState) {
        this.riskState = riskState;
        return this;
    }
    ...
    public DiscountCoverageRating withRiskStateStatCode(String riskStateStatCode) {
        this.riskStateStatCode = riskStateStatCode;
        return this;
    }
    ...
    public DiscountCoverageRating withWaivedPremium(String waivedPremium) {
        this.waivedPremium = waivedPremium;
        return this;
    }

    @JsonProperty("PremiumAttributes")
    public PremiumAttributes__12 getPremiumAttributes() {
        return premiumAttributes;
    }

    @JsonProperty("PremiumAttributes")
    public void setPremiumAttributes(PremiumAttributes__12 premiumAttributes) {
        this.premiumAttributes = premiumAttributes;
    }

    public DiscountCoverageRating withPremiumAttributes(PremiumAttributes__12 premiumAttributes) {
        this.premiumAttributes = premiumAttributes;
        return this;
    }
    ...
    public DiscountCoverageRating withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DiscountCoverageRating.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cCoverage");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("cDiscountCovRating");
        sb.append('=');
        sb.append(((this.cDiscountCovRating == null)?"<null>":this.cDiscountCovRating));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.cDiscountCovRating == null)? 0 :this.cDiscountCovRating.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DiscountCoverageRating) == false) {
            return false;
        }
        DiscountCoverageRating rhs = ((DiscountCoverageRating) other);
        return (((((((((((((((((((this.riskStateStatCode == rhs.riskStateStatCode)||((this.riskStateStatCode!= null)&&this.riskStateStatCode.equals(rhs.riskStateStatCode)))&&((this.cRatingFormula == rhs.cRatingFormula)||((this.cRatingFormula!= null)&&this.cRatingFormula.equals(rhs.cRatingFormula))))&&((this.cDiscountCovRating == rhs.cDiscountCovRating)||((this.cDiscountCovRating!= null)&&this.cDiscountCovRating.equals(rhs.cDiscountCovRating))))&&((this.entityType == rhs.entityType)||((this.entityType!= null)&&this.entityType.equals(rhs.entityType))))&&((this.isCovManuallyRated == rhs.isCovManuallyRated)||((this.isCovManuallyRated!= null)&&this.isCovManuallyRated.equals(rhs.isCovManuallyRated))))&&((this.cRatingFunction == rhs.cRatingFunction)||((this.cRatingFunction!= null)&&this.cRatingFunction.equals(rhs.cRatingFunction))))&&((this.waivedPremium == rhs.waivedPremium)||((this.waivedPremium!= null)&&this.waivedPremium.equals(rhs.waivedPremium))))&&((this.cCoverage == rhs.cCoverage)||((this.cCoverage!= null)&&this.cCoverage.equals(rhs.cCoverage))))&&((this.cSeq == rhs.cSeq)||((this.cSeq!= null)&&this.cSeq.equals(rhs.cSeq))))&&((this.productCode == rhs.productCode)||((this.productCode!= null)&&this.productCode.equals(rhs.productCode))))&&((this.entityStatus == rhs.entityStatus)||((this.entityStatus!= null)&&this.entityStatus.equals(rhs.entityStatus))))&&((this.entityReference == rhs.entityReference)||((this.entityReference!= null)&&this.entityReference.equals(rhs.entityReference))))&&((this.cCoverageCode == rhs.cCoverageCode)||((this.cCoverageCode!= null)&&this.cCoverageCode.equals(rhs.cCoverageCode))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.cFinalAnnDisPremium == rhs.cFinalAnnDisPremium)||((this.cFinalAnnDisPremium!= null)&&this.cFinalAnnDisPremium.equals(rhs.cFinalAnnDisPremium))))&&((this.lobCode == rhs.lobCode)||((this.lobCode!= null)&&this.lobCode.equals(rhs.lobCode))))&&((this.riskState == rhs.riskState)||((this.riskState!= null)&&this.riskState.equals(rhs.riskState))))&&((this.premiumAttributes == rhs.premiumAttributes)||((this.premiumAttributes!= null)&&this.premiumAttributes.equals(rhs.premiumAttributes))));
    }
