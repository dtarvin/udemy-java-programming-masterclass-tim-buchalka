...
public class PremiumAttributes__10 {
    ...
    public PremiumAttributes__10 withAnnualPremium(String annualPremium) {
        this.annualPremium = annualPremium;
        return this;
    }
    ...
    public PremiumAttributes__10 withBalanceToMinimum(String balanceToMinimum) {
        this.balanceToMinimum = balanceToMinimum;
        return this;
    }
    ...
    public PremiumAttributes__10 withCommissionablePremium(String commissionablePremium) {
        this.commissionablePremium = commissionablePremium;
        return this;
    }
    ...
    public PremiumAttributes__10 withFullTermPremium(String fullTermPremium) {
        this.fullTermPremium = fullTermPremium;
        return this;
    }
    ...
    public PremiumAttributes__10 withIsSubToFullyCharge(String isSubToFullyCharge) {
        this.isSubToFullyCharge = isSubToFullyCharge;
        return this;
    }
    ...
    public PremiumAttributes__10 withIsSubToFullyEarn(String isSubToFullyEarn) {
        this.isSubToFullyEarn = isSubToFullyEarn;
        return this;
    }
    ...
    public PremiumAttributes__10 withTransactionPremium(String transactionPremium) {
        this.transactionPremium = transactionPremium;
        return this;
    }
    ...
    public PremiumAttributes__10 withTransPremNotSubToAud(String transPremNotSubToAud) {
        this.transPremNotSubToAud = transPremNotSubToAud;
        return this;
    }
    ...
    public PremiumAttributes__10 withWrittenPremium(String writtenPremium) {
        this.writtenPremium = writtenPremium;
        return this;
    }
    ...
    public PremiumAttributes__10 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PremiumAttributes__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PremiumAttributes__10) == false) {
            return false;
        }
        PremiumAttributes__10 rhs = ((PremiumAttributes__10) other);
