...
public class PremiumAttributes__5 {
    ...
    public PremiumAttributes__5 withAnnualPremium(String annualPremium) {
        this.annualPremium = annualPremium;
        return this;
    }
    ...
    public PremiumAttributes__5 withBalanceToMinimum(String balanceToMinimum) {
        this.balanceToMinimum = balanceToMinimum;
        return this;
    }
    ...
    public PremiumAttributes__5 withCommissionablePremium(String commissionablePremium) {
        this.commissionablePremium = commissionablePremium;
        return this;
    }
    ...
    public PremiumAttributes__5 withFullTermPremium(String fullTermPremium) {
        this.fullTermPremium = fullTermPremium;
        return this;
    }
    ...
    public PremiumAttributes__5 withIsSubToFullyCharge(String isSubToFullyCharge) {
        this.isSubToFullyCharge = isSubToFullyCharge;
        return this;
    }
    ...
    public PremiumAttributes__5 withIsSubToFullyEarn(String isSubToFullyEarn) {
        this.isSubToFullyEarn = isSubToFullyEarn;
        return this;
    }
    ...
    public PremiumAttributes__5 withTransactionPremium(String transactionPremium) {
        this.transactionPremium = transactionPremium;
        return this;
    }
    ...
    public PremiumAttributes__5 withTransPremNotSubToAud(String transPremNotSubToAud) {
        this.transPremNotSubToAud = transPremNotSubToAud;
        return this;
    }
    ...
    public PremiumAttributes__5 withWrittenPremium(String writtenPremium) {
        this.writtenPremium = writtenPremium;
        return this;
    }
    ...
    public PremiumAttributes__5 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PremiumAttributes__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PremiumAttributes__5) == false) {
            return false;
        }
        PremiumAttributes__5 rhs = ((PremiumAttributes__5) other);
