...
public class PremiumAttributes__7 {
    ...
    public PremiumAttributes__7 withAnnualPremium(String annualPremium) {
        this.annualPremium = annualPremium;
        return this;
    }
    ...
    public PremiumAttributes__7 withBalanceToMinimum(String balanceToMinimum) {
        this.balanceToMinimum = balanceToMinimum;
        return this;
    }
    ...
    public PremiumAttributes__7 withCommissionablePremium(String commissionablePremium) {
        this.commissionablePremium = commissionablePremium;
        return this;
    }
    ...
    public PremiumAttributes__7 withFullTermPremium(String fullTermPremium) {
        this.fullTermPremium = fullTermPremium;
        return this;
    }
    ...
    public PremiumAttributes__7 withTransactionPremium(String transactionPremium) {
        this.transactionPremium = transactionPremium;
        return this;
    }
    ...
    public PremiumAttributes__7 withTransPremNotSubToAud(String transPremNotSubToAud) {
        this.transPremNotSubToAud = transPremNotSubToAud;
        return this;
    }
    ...
    public PremiumAttributes__7 withWrittenPremium(String writtenPremium) {
        this.writtenPremium = writtenPremium;
        return this;
    }
    ...
    public PremiumAttributes__7 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PremiumAttributes__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PremiumAttributes__7) == false) {
            return false;
        }
        PremiumAttributes__7 rhs = ((PremiumAttributes__7) other);
