...
public class PremiumAttributes__11 {
    ...
    public PremiumAttributes__11 withAnnualPremium(String annualPremium) {
        this.annualPremium = annualPremium;
        return this;
    }
    ...
    public PremiumAttributes__11 withBalanceToMinimum(String balanceToMinimum) {
        this.balanceToMinimum = balanceToMinimum;
        return this;
    }
    ...
    public PremiumAttributes__11 withCommissionablePremium(String commissionablePremium) {
        this.commissionablePremium = commissionablePremium;
        return this;
    }
    ...
    public PremiumAttributes__11 withFullTermPremium(String fullTermPremium) {
        this.fullTermPremium = fullTermPremium;
        return this;
    }
    ...
    public PremiumAttributes__11 withTransactionPremium(String transactionPremium) {
        this.transactionPremium = transactionPremium;
        return this;
    }
    ...
    public PremiumAttributes__11 withTransPremNotSubToAud(String transPremNotSubToAud) {
        this.transPremNotSubToAud = transPremNotSubToAud;
        return this;
    }
    ...
    public PremiumAttributes__11 withWrittenPremium(String writtenPremium) {
        this.writtenPremium = writtenPremium;
        return this;
    }
    ...
    public PremiumAttributes__11 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PremiumAttributes__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PremiumAttributes__11) == false) {
            return false;
        }
        PremiumAttributes__11 rhs = ((PremiumAttributes__11) other);
