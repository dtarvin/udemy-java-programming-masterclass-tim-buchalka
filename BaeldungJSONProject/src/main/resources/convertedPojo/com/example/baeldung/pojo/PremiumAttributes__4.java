...
public class PremiumAttributes__4 {
    ...
    public PremiumAttributes__4 withAnnualPremium(String annualPremium) {
        this.annualPremium = annualPremium;
        return this;
    }
    ...
    public PremiumAttributes__4 withBalanceToMinimum(String balanceToMinimum) {
        this.balanceToMinimum = balanceToMinimum;
        return this;
    }
    ...
    public PremiumAttributes__4 withCommissionablePremium(String commissionablePremium) {
        this.commissionablePremium = commissionablePremium;
        return this;
    }
    ...
    public PremiumAttributes__4 withFullTermPremium(String fullTermPremium) {
        this.fullTermPremium = fullTermPremium;
        return this;
    }
    ...
    public PremiumAttributes__4 withIsSubToFullyCharge(String isSubToFullyCharge) {
        this.isSubToFullyCharge = isSubToFullyCharge;
        return this;
    }
    ...
    public PremiumAttributes__4 withIsSubToFullyEarn(String isSubToFullyEarn) {
        this.isSubToFullyEarn = isSubToFullyEarn;
        return this;
    }
    ...
    public PremiumAttributes__4 withTransactionPremium(String transactionPremium) {
        this.transactionPremium = transactionPremium;
        return this;
    }
    ...
    public PremiumAttributes__4 withTransPremNotSubToAud(String transPremNotSubToAud) {
        this.transPremNotSubToAud = transPremNotSubToAud;
        return this;
    }
    ...
    public PremiumAttributes__4 withWrittenPremium(String writtenPremium) {
        this.writtenPremium = writtenPremium;
        return this;
    }
    ...
    public PremiumAttributes__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PremiumAttributes__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PremiumAttributes__4) == false) {
            return false;
        }
        PremiumAttributes__4 rhs = ((PremiumAttributes__4) other);
